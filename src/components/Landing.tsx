...
interface MyState { email: string, password: string, isAuth: boolean };
                        ...
                        <div className="hidden lg:block">
                            <ul className="inline-flex">
...

                                {
                                    this.props.isAuth &&
                                    <li>
                                        <NavLink to="/" onClick={this.logoutHandler} className="bg-red-500 ml-4 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                                            Log Out
                                        </NavLink>
                                    </li>
                                }
